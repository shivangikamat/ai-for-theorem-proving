...
class AutoscalerStateServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ResizeRayletResourceInstances = channel.unary_unary(
                '/ray.rpc.autoscaler.AutoscalerStateService/ResizeRayletResourceInstances',
                request_serializer=src_dot_ray_dot_protobuf_dot_autoscaler__pb2.ResizeRayletResourceInstancesRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_autoscaler__pb2.ResizeRayletResourceInstancesReply.FromString,
                )
...
class AutoscalerStateServiceServicer(object):
    ...
    def ResizeRayletResourceInstances(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AutoscalerStateServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ResizeRayletResourceInstances': grpc.unary_unary_rpc_method_handler(
                    servicer.ResizeRayletResourceInstances,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_autoscaler__pb2.ResizeRayletResourceInstancesRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_autoscaler__pb2.ResizeRayletResourceInstancesReply.SerializeToString,
            ),
    }
...
class AutoscalerStateService(object):
    ...
    @staticmethod
    def ResizeRayletResourceInstances(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.autoscaler.AutoscalerStateService/ResizeRayletResourceInstances',
            src_dot_ray_dot_protobuf_dot_autoscaler__pb2.ResizeRayletResourceInstancesRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_autoscaler__pb2.ResizeRayletResourceInstancesReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
